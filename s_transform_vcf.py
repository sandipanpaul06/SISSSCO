...
train_mean = np.load(path1 + '/TFA/' + 'train_mean_stockwell.npy')
train_SD = np.load(path1 + '/TFA/' + 'train_SD_stockwell.npy')
'''
...
np.save("TFA/X_"+ ss_file[11:16] +"_stockwell", X_test_1)
